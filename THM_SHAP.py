...
def save_shap_beeswarm_and_importance(
    ...
    print(f"📁 contribution: {excel_path}")
...
for seed in seeds:
    ...
    if seed == 42:
        ...
        shap_plot_path = 'shap_summary_plot_THM4_seed42.svg'
...
if seed42_train_pred_df is None or seed42_test_pred_df is None:
    raise ValueError('fail to save seed=42 result。')

# =========================

output_file = 'catboost_THM4_results_.xlsx'
